...
public class Storage {
  ...
  public void addContent(final String product, int quantity) throws Exception {
    ...
    // assert currentQuantity + quantity <= capacity;
  ...
  public void pullContent(String product, int quantity) throws Exception {
    ...
    // assert storage.get(product) != null;
    ...
    int storageQuantity = storage.get(product);
    if (storageQuantity < quantity) {
        throw new InsufficientProductException(product, storageQuantity, quantity);
    }
    // assert storageQuantity >= quantity;
